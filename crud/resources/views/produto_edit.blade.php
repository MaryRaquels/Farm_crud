    ...
    <div class="card bg-light shadow-lg" style="width: 28rem; height: 28rem">
        <div class="card-body text-center">
            <form action="{{ route('produtos.update', ['produto' => $produto->id]) }}" method="POST">
                ...
                <!--Botões-->
                <div class="space-y-2">
                    <button type="submit" class="w-full btn btn-info text-white font-semibold py-2 px-4 rounded-lg transition duration-300">Atualizar</button>
                    <button class="w-full bg-gray-500 hover:bg-gray-600 text-white font-semibold py-2 px-4 rounded-lg transition duration-300">
